...
return"audio"===t.type?_react2.default.createElement("li",{ref:function(t){e.nodes.thumb.push(t)},key:o.toString(),className:"pool-item"},this.renderSlelectBtn(t),_react2.default.createElement("img",{src:t.thumbSrc,width:t.thumbWidth,height:t.thumbHeight,alt:"thumbnail of audio content",onClick:function(){e.showLigthBox(t,o)}})):""==t.type||void 0==t.type?void this.console("Bug on CrowMediaGallery => renderAudioItemThumb func || you need to write type ('video', 'image', 'song') property in items pool "):void 0}},{key:"renderPoolListThumb",value:function(){if(!1!==this.state.showGallery)return _react2.default.createElement("ul",{key:"r1",className:"crow-media-gallery-pool-list"},this.renderPoolItemsThumb())}},{key:"renderLightBoxReader",value:function(){var e=this
if(!1!==this.state.showLightBox)return this.lightboxSettings.showLightBox=this.state.showLightBox,_react2.default.createElement(_crowLightboxReader2.default,{closeCallBack:function(){e.setState({showLightBox:!1,showGallery:!0})},isRead:this.itemIndexClicked,items:this.state.poolItems,settings:this.lightboxSettings})}},{key:"showRenderer",value:function(){var e=[]
