...
return o.poolItems=e.items||[],o.onSelect=e.onSelect||!1,o.onCustomClick=e.onCustomClick||!1,o.itemIndexClicked=null,o.showSelect=e.settings.showSelect||!0,o.debug=e.settings.debug||!1,o.nodes={thumb:[]},o.state={selectItem:!1,showLightBox:!1,showGalery:!0},o}return _inherits(t,e),_createClass(t,[{key:"console",value:function(e){function t(){return e.apply(this,arguments)}return t.toString=function(){return e.toString()},t}(function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:""
...
this.itemIndexClicked=t,this.setState({showLightBox:!0,showGalery:!1})}},{key:"renderVideoItemThumb",value:function(){var e=this,t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",o=arguments[1]
...
return"audio"===t.type?_react2.default.createElement("li",{ref:function(t){e.nodes.thumb.push(t)},key:o.toString(),className:"pool-item"},this.renderSlelectBtn(t),_react2.default.createElement("img",{src:t.thumbSrc,width:t.thumbWidth,height:t.thumbHeight,alt:"thumbnail of audio content",onClick:function(){e.showLigthBox(t,o)}})):""==t.type||void 0==t.type?void this.console("Bug on CrowMediaGallery => renderAudioItemThumb func || you need to write type ('video', 'image', 'song') property in items pool "):void 0}},{key:"renderPoolListThumb",value:function(){if(!1!==this.showPool)return _react2.default.createElement("ul",{key:"r1",className:"crow-media-gallery-pool-list"},this.renderPoolItemsThumb())}},{key:"renderLightBoxReader",value:function(){var e=this,t={showPool:!0,showBtn:!0,showDesc:!0,showLightBox:this.state.showLightBox,debug:!1}
if(!1!==this.state.showLightBox)return _react2.default.createElement(_crowLightboxReader2.default,{closeCallBack:function(){e.setState({showLightBox:!1,showGalery:!0})},isRead:this.itemIndexClicked,items:this.poolItems,settings:t})}},{key:"showRenderer",value:function(){var e=[]
return e.push(this.renderPoolListThumb()),!1!==this.state.showGalery?_react2.default.createElement("div",null,_react2.default.createElement("div",{className:"crow-media-gallery"},e)):_react2.default.createElement("div",null,this.renderLightBoxReader())}},{key:"render",value:function(){return this.showRenderer()}}]),t}(_react.Component)
